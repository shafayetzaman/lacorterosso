    ...
    <div className="relative h-[70vh] md:h-[80vh] lg:h-[90vh] bg-charcoal overflow-hidden font-manrope">
      <div className="relative h-full w-full">
        <div className="absolute inset-0 w-full h-full">
          <img
            src="./reserveHero.webp"
            alt="Reserve hero"
            loading="eager"
            className="w-full h-full object-cover animate-[fadeInScale_1s_ease-out] grayscale"
          />
        ...
        <div className="relative h-full flex flex-col items-center justify-center px-6 md:px-12 text-center">
          <div className="max-w-4xl mx-auto space-y-6">
            ...
            <p className="text-ivory text-base text-sm md:text-lg lg:text-xl max-w-2xl mx-auto leading-relaxed font-light animate-[fadeInUp_1s_ease-out_0.7s_both]">
              We invite you to reserve your table online or via phone if you cannot find a suitable time. Our reservation lines are open Tuesday–Friday, 9:00 AM – 6:00 PM, and Saturday, 10:00 AM – 5:00 PM. All reservations are secured with a credit or debit card and may be canceled with 24 hours' notice. Please note, due to limited space, prams cannot be accommodated.
            </p>
          </div>
        </div>
